...
enum FundingStatus: string
{
    ...
    {
        return match ($this) {
            self::FundingSuccessful => 'bg-emerald-500/15 text-emerald-300 ring-1 ring-emerald-400/30',
            self::PaymentSuccessful, self::FundingProcessing => 'bg-sky-500/15 text-sky-300 ring-1 ring-sky-400/30',
            self::PaymentPending => 'bg-slate-400/15 text-slate-300 ring-1 ring-slate-400/30',
            self::ManualReview => 'bg-amber-500/15 text-amber-300 ring-1 ring-amber-400/30',
            self::FundingFailed => 'bg-rose-500/15 text-rose-300 ring-1 ring-rose-400/30',
            self::Refunded => 'bg-violet-500/15 text-violet-300 ring-1 ring-violet-400/30',
        };
    }
