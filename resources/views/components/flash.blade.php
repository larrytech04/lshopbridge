@php
    $map = [
        'success' => ['cls' => 'border-emerald-400/30 bg-emerald-500/10 text-emerald-600', 'icon' => 'check-circle'],
        'error' => ['cls' => 'border-rose-400/30 bg-rose-500/10 text-rose-600', 'icon' => 'alert'],
        'warning' => ['cls' => 'border-amber-400/30 bg-amber-500/10 text-amber-600', 'icon' => 'alert'],
        'info' => ['cls' => 'border-sky-400/30 bg-sky-500/10 text-sky-600', 'icon' => 'info'],
    ];
@endphp
...
@if (session('otp_debug'))
    <div class="mb-4 flex items-center gap-3 rounded-2xl border border-brand-400/30 bg-slate-500/10 px-4 py-3 text-brand-600">
...
@if ($errors->any())
    <div class="mb-4 rounded-2xl border border-rose-400/30 bg-rose-500/10 px-4 py-3 text-rose-600">
