...
@php
    ...
    $custom = [
        ...
        'card'       => '<circle cx="16" cy="16" r="16" fill="#4338CA"/><rect x="7.5" y="11" width="17" height="12" rx="2" fill="#fff"/><rect x="7.5" y="14" width="17" height="2.6" fill="#4338CA"/><rect x="10" y="19" width="5" height="1.8" rx=".9" fill="#4338CA"/>',
