...
<div class="space-y-6">
    <a href="{{ route('learning.index') }}" class="text-sm text-brand-500 hover:text-brand-600">← {{ __('Learning center') }}</a>
        ...
        <article class="min-w-0 space-y-8">
            ...
            @if ($prev || $next)
                <div class="grid gap-3 sm:grid-cols-2">
                    @if ($prev)
                        <a href="{{ route('learning.show', $prev) }}" class="rounded-2xl border border-app p-4 transition hover:surface-2">
                    ...
                    @endif
                    @if ($next)
                        <a href="{{ route('learning.show', $next) }}" class="rounded-2xl border border-app p-4 text-right transition hover:surface-2">
                ...
                <div>
                    ...
                    <div class="grid gap-4 sm:grid-cols-3">
                        @foreach ($related as $r)
                            <a href="{{ route('learning.show', $r) }}" class="rounded-2xl border border-app p-4 transition hover:surface-2">
